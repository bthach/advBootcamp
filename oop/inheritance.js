...
// New would do the same thing, but add additional unnecessary properties on the prototype object.

// Student.prototype.constructor = Student;

// Inheritance, set prototype to be object created with another prototype and reset constructor property.
...
function Motorcycle(make, model, year){
    Vehicle.apply(this, arguments); // why no return
    this.numWheels = 2;
}
