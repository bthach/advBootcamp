...
Person.prototype.addToFamily = function(name) {
    if (name instanceof Person && this.family.indexOf(name) === -1) {
...
Array.prototype.map = function(callback) {
    ...
    for (var i = 0; i < this.length; i++) {
        newArr.push(callback(this[i], i, this)); // map takes in current value, index, and array
    }
    return newArr;
}
