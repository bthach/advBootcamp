...
// Call and Apply executes function. Binds returns a function
...
function arrayFrom(arrayLikeObject){
    ...
    [] Array object
    .slice acceses the function slice present in the prototype of Array
    .call accesses the function call present in the protoype of function objects
    arrayLikeObject
    Call can have arguments like (thisArg, arg1, arg2, ..n)
    Passing arrayLikeObject. Served as this object inside of slice function
...
function sumEvenArguments(){
    ...
    // Array method reduce executes a function and provides a single result.

    return argList.reduce(function(acc, next) {
        if (next % 2 === 0) {
            return acc += next;
            console.log(acc);
        }
